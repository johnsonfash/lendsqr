        ...
        <div className="shadow-sm rounded-3 bg-white pt-4 px-4">
          <div className="d-flex flex-wrap align-items-center  mb-4">
            <div className="d-flex align-items-center">
              <div className="d-inline-block fs-3 bg-light min-w-4 min-h-4 d-flex justify-content-center align-items-center rounded-circle border">
                <FontAwesomeIcon icon={faUser} />
              </div>
              <div className="border-end ps-3 pe-4">
                <h6>Grace Effiom</h6>
                <small className="text-muted">LSFUEIIf893d0</small>
              </div>
            </div>
          ...
          <div className="overflow-slider">
            ...
            <span className="d-inline-block link px-4 py-1 mx-lg-3">Loans</span>
            <span className="d-inline-block link px-4 py-1 mx-lg-3">
              Savings
            </span>
